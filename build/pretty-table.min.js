...
if(_.isObject(this.data)){this.node=new PrettyJSON.view.Node({el:this.el,data:this.data,compareTo:this.dataCouterpart,compare:true,counterpart:nodeCounterpart});}else{console.log(this.data)
